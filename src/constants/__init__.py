...
DATABASE_NAME = 'MLops-Project1'
COLLECTION_NAME = 'project1_data'

MONGODB_URL_KEY = "MONGODB_URL"         #export MONGODB_URL="mongodb+srv://santosh4thmarch_db_user:santosh@#9605@cluster0.5cjjjrf.mongodb.net/?appName=Cluster0" 
