...
class TrainPipeline:
    def __init__(self):
        ...
        self.model_trainer_config = XGBoostConfig()
    ...
    def start_data_validation(self, data_ingestion_artifact: Data_Ingestion_artifact) -> DataValidationArtifact:
        """
    ...
    def start_data_transformation(self, data_ingestion_artifact: Data_Ingestion_artifact, data_validation_artifact: DataValidationArtifact) -> DataTransformationArtifact:
        """
    ...
    def start_model_evaluation(self, data_ingestion_artifact: Data_Ingestion_artifact,
    ...
    def run_pipeline(self) -> None:
        ...
        try:
            ...
            ## logic --> if current modele is better than previous one in artifact then it will push the
            #   model into s3 else no
