...
from src.entity.artifact_entity import ModelTrainerArtifact, Data_Ingestion_artifact, ModelEvaluationArtifact
...
class ModelEvaluation:
    ...
    def __init__(self, model_eval_config: ModelEvaluationConfig, data_ingestion_artifact: Data_Ingestion_artifact,
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            best_model = self.get_best_model()     # fetching  best model from aws s3
