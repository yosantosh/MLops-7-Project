...
from src.entity.artifact_entity import DataTransformationArtifact, Data_Ingestion_artifact, DataValidationArtifact
...
class DataTransformation:
    def __init__(self, data_ingestion_artifact: Data_Ingestion_artifact,
        ...
        try:
            ...
            self.data_validation_report_path = DataValidationConfig.validation_report_file_path
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # validation report check: if data validation failed, then raise exception
            # with open(self.data_validation_config.validation_report_file_path, "r") as f:
            #     data = yaml.safe_load(f)         
            # message = data["message"]
            # if message!="Data validation successful.":
